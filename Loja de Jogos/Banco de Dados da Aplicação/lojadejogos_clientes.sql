...
CREATE TABLE `clientes` (
  ...
  `usuarioCliente` varchar(20) DEFAULT NULL,
  `senhaCliente` varchar(25) DEFAULT NULL,
  `comprasFeitas` int DEFAULT NULL,
  `dinheiroGasto` decimal(6,2) DEFAULT NULL,
  PRIMARY KEY (`idCliente`),
  UNIQUE KEY `usuarioCliente` (`usuarioCliente`)
