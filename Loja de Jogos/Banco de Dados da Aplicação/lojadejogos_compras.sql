...
CREATE TABLE `compras` (
  ...
  `reference_jogo_plataforma` int DEFAULT NULL,
  `dataDeCompra` date DEFAULT NULL,
  PRIMARY KEY (`idCompra`),
  KEY `idComprador` (`idComprador`),
  KEY `reference_jogo_plataforma` (`reference_jogo_plataforma`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`idComprador`) REFERENCES `clientes` (`idCliente`),
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`reference_jogo_plataforma`) REFERENCES `jogos_plataformas` (`idRegistro`)
