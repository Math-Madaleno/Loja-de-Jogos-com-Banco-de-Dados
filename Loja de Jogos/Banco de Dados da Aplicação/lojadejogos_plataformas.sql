...
CREATE TABLE `plataformas` (
  ...
  UNIQUE KEY `nome` (`nomePlataforma`)
...
INSERT INTO `plataformas` VALUES (12,'Google Stadia'),(11,'Mobile'),(10,'Nintendo Switch'),(9,'PC'),(1,'PS3'),(3,'PS4'),(4,'PS5'),(2,'Xbox One 360'),(6,'Xbox One S'),(5,'Xbox One X'),(8,'Xbox Series S'),(7,'Xbox Series X');
